...
class sdr_test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sdr_test1")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\KIIT\\Desktop\\Sea of tranquility\\GNU radio\\rf_rx.dat', False)
...
def main(top_block_cls=sdr_test1, options=None):
